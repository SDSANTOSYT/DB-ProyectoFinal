...
CREATE TABLE AULA (
  ...
  ID_TUTOR NUMBER,
  ID_PROGRAMA NUMBER,
  CONSTRAINT PK_AULA PRIMARY KEY (ID_AULA, ID_SEDE),
...
CREATE TABLE ESTUDIANTE (
  ...
  ID_AULA NUMBER,
  ID_SEDE NUMBER,
  CONSTRAINT FK_ESTUDIANTE_AULA FOREIGN KEY (ID_AULA, ID_SEDE) REFERENCES AULA(ID_AULA, ID_SEDE)
);
...
CREATE TABLE HORARIO (
  ...
  ID_AULA NUMBER,
  ID_SEDE NUMBER,
  CONSTRAINT FK_HORARIO_AULA FOREIGN KEY (ID_AULA, ID_SEDE) REFERENCES AULA(ID_AULA, ID_SEDE)
);
...
CREATE TABLE ASISTENCIA_AULA_TUTOR (
  ID_ASISTENCIA_AULA_TUTOR NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
  FECHA DATE,
  ...
  CONSTRAINT FK_AATT_REPOSICION FOREIGN KEY (ID_ASISTENCIA_REPOSICION) REFERENCES ASISTENCIA_AULA_TUTOR(ID_ASISTENCIA_AULA_TUTOR)
);

-- 15. ASISTENCIA_AULA_ESTUDIANTE
CREATE TABLE ASISTENCIA_AULA_ESTUDIANTE (
  ID_ASISTENCIA_AULA_ESTUDIANTE NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
  FECHA DATE,
  ID_ESTUDIANTE NUMBER,
